        ...
        <div class="row">
            <div class="col-xl-12 col-md-12 mb-12 text-center">
                ...
                <div class="row text-center border-bottom-mvc mb-2">
                    ...
                    <div class="col-lg-12 col-xl-12 col-md-12 mb-12 border-left-mvc text-center p-2 mb-2"><h1
                                class="h3 mb-0 text-gray-800"><i class="fas fa-search basliktext"></i> SİPARİŞ ARAMA
                        </h1></div>
                </div>
                    ...
                    <div class="col-xl-11 col-md-9 mb-12 text-left   ">
                        <div class="row">
                            ...
                            <div class="col-xl-2 p-2 eleman2">
                                ...
                                Form::OlusturSelect("1", array("name" => "kargodurum", "class" => "form-control p-1"));
                            ...
                            <div class="col-xl-2 p-2 eleman2 noaltcizgi">
                                ...
                                Form::OlusturOption(array("value" => "1"), false, "Tamamlandı");
                                Form::OlusturOption(array("value" => "2"), false, "İade");
                                Form::OlusturOption(array("value" => "3"), false, "İade Tamamlandı");
                                Form::OlusturSelect("2", null);
                                ?>
                ...
                if (isset($veri["varsayilan"])) :
                    ...
                    echo "<div class='alert alert-danger'>Lütfen Arama Kriteri Seçiniz</div>";
                ...
                if (isset($veri["data"])) :
                    ...
                    $endValue = join(",",$temizsiparisnumaralari);
                    Session::set("number",$endValue);



                   echo '<div class="alert alert-danger">'.$veri["aramakriter"].'</div>';
                    echo '<a href="'.URL.'/panel/SiparislerExcelCreate" class="btn btn-primary">Excele Aktar</a>';
