        ...
        <div class="row">
            <div class="col-xl-12 col-md-12 mb-12 text-center">
                    ...
                    if (!$_POST) :
                        ...
                        <div class="row text-left border-bottom-mvc mb-2">
                            ...
                            <div class="col-xl-12 col-md-12 mb-12 border-left-mvc text-left p-2 mb-2"><h1
                                        class="h3 mb-0 text-gray-800"><i class="fas fa-th basliktext"></i> KARGO DURUMU
                                    GÜNCELLE </h1></div>

                                <?php $PanelHarici->BreadCrumb("siparisler","Siparişler","Kargo Durum Güncelle");?>
                                ...
                                <div class="col-xl-4 col-md-6 mx-auto">
                                    ...
                                    <div class="row bg-gradient-beyazimsi">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 bg-gradient-mvc pt-2 basliktext2"><h3>
                                                Kargo Durum Güncelle</h3></div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 formeleman">Mevcut Sipariş Durumu
                                        </div>
                ...
                if (isset($veri["data"])) :
                    ...
                    $siparisnumUnique = array_unique($siparisnum, SORT_STRING);
                    ...
                    <div class="row text-left border-bottom-mvc mb-2">
                        ...
                        <div class="col-lg-2 col-xl-2 col-md-12 mb-12 border-left-mvc text-left p-2 mb-2"><h1
                                    class="h4 mb-0 text-gray-800"><i class="fas fa-th basliktext"></i> SİPARİŞLER </h1>
                        </div>


                        <div class="col-lg-3 col-xl-3 col-md-12 mb-12 p-2"><h1 class="h4 mb-0 text-gray-800">Toplam
                                sipariş : <?php echo count($siparisnumUnique); ?></h1></div>
                    ...
                    foreach ($siparisnumUnique as $value) :
                        ...
                        <div class="row arkaplan p-1 mt-2 pb-0">
                            ...
                            <div class="col-xl-1 col-lg-1 col-md-12 col-sm-12 pt-3 geneltext bg-gradient-mvc">
                                <span>Üye Adı :</span> <span class="spantext"><?php echo $veriler[0]["uyead"]; ?></span>
                            </div>
                    ...
                    ?>
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-12 col-sm-12 pt-3 geneltext bg-gradient-mvc">
                                <span>Ödeme Türü :</span> <span
                                        class="spantext"><?php echo $veriler[0]["odemeturu"]; ?></span>
                            </div>

                            <div class="col-xl-2 col-lg-2 col-md-12 col-sm-12 pt-3 geneltext bg-gradient-mvc"
                                 id="detaygoster">
                                <span>Tarih :</span> <span class="spantext"><?php echo $veriler[0]["tarih"]; ?></span>
                                <a class="btn btn-dark" data-value="<?php echo $value; ?>"
                                   data-value2="<?php echo $veriler[0]["adresid"]; ?>" data-toggle="modal"
                                   data-target="#exampleModalCenter" id="adres"><i class="fas fa-dolly"></i></a>

                                <a class="btn btn-dark" data-value="<?php echo $value; ?>"
                                   data-value2="<?php echo $veriler[0]["adresid"]; ?>" data-toggle="modal"
                                   data-target="#exampleModalCenter" id="siparis"><i class="fas fa-print"></i></a>

                            </div>

                            <div class="col-xl-2 col-lg-2 col-md-12 col-sm-12 geneltext bg-gradient-mvc">

                                <a href="<?php echo URL . "/panel/kargoguncelle/" . $value; ?>"
                                   class="btn btn-sm btn-success btn-block mb-1">GÜNCELLE</a>
                            </div>
...
<div class="col-lg-3 text-dark kalinyap p-2">' . number_format($value["urunfiyat"], 2, ",", ".") . ' TL</div>
<div class="col-lg-3 text-dark kalinyap p-2">' . number_format($value["toplamfiyat"], 2, ",", ".") . ' TL</div>             
                     </div> ';
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-2  geneltext2 text-right p-2"><span>SİPARİŞ TOPLAMI :</span>
                                    </div>
