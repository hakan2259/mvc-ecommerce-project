                        ...
                        <div class="col-lg-12">
                            <div class="p-5">
                                ...
                                Form::Olustur("1", array(
                                    "action" => URL . "/uye/admingiriskontrol",
                                    "method" => "POST",
                                ...
                                <div class="form-group">
                                    ...
                                    <?php
                                    Form::Olustur("2", array("type" => "text", "class" => "form-control form-control-user", "name" => "adminkuladi", "autofocus" => "autofocus", "required" => "required",
                                ...
                                <div class="form-group">
                                    ...
                                    <?php
                                    Form::Olustur("2", array("type" => "password", "class" => "form-control form-control-user", "name" => "adminsifre", "autofocus" => "autofocus", "required" => "required",
                                        "placeholder" => "Şifrenizi Giriniz", "id" => "exampleInputPassword"));
                                    ?>
                                ...
                                <div class="form-group text-center">
                                    ...
                                    Form::Olustur("2", array("type" => "submit", "value" => "GİRİŞ YAP", "class" => "btn btn-danger", "name" => "admingiris"));
                                    Form::Olustur("kapat");
                                    if(isset($veri["bilgi"])):
                                        echo $veri["bilgi"];
                                    endif;
