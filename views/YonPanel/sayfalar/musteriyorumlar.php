<?php require 'views/YonPanel/header.php'; ?>
      ...
      <!-- BAŞLIK -->
       ...
       <div class="row text-left border-bottom-mvc mb-2">
           <?php $PanelHarici->BreadCrumb("uyeler","Üyeler","Üye Yorumları")?>
       
        	 <div class="col-lg-4 col-xl-4 col-md-12 mb-12 border-left-mvc text-left p-2 mb-2"><h1 class="h3 mb-0 text-gray-800"> <i class="fas fa-comment basliktext"></i> MÜŞTERİ YORUMLARI </h1></div>
...
<div class="col-xl-1 col-lg-1 col-md-12 col-sm-12 text-dark kalinyap p-2 text-right">
	...
	echo $value["durum"]==1 ? '' :	'<a onclick=\'UyeYorumOnay("'.$value["id"].'","1")\' class="fas fa-check mt-1  text-success" style="font-size: 15px; cursor: pointer;"></a>';
		echo'</div>
		<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 text-dark kalinyap  text-center">	

 <a onclick=\'UyeYorumOnay("'.$value["id"].'","2")\' class="fas fa-times silbuton text-danger" style="font-size: 25px; cursor: pointer;" ></a> 
		</div>
	</div>
		...
		Pagination::Numbers($veri["toplamsayfa"],"/panel/musteriyorumlar/");
