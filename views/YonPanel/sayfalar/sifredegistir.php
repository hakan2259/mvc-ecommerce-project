                ...
                if (isset($veri["sifredegistir"])) :
                    ...
                    <div class="row text-left border-bottom-mvc mb-2">
                        ...
                        <div class="col-xl-12 col-md-12 mb-12 border-left-mvc text-left p-2 mb-2"><h1
                                    class="h3 mb-0 text-gray-800"><i class="fas fa-th basliktext"></i> ŞİFRE DEĞİŞTİRME
                            </h1></div>

                        <?php $PanelHarici->BreadCrumb("siparisler","Anasayfa","Yönetici Şifre Değiştirme")?>
                                ...
                                <div class="row bg-gradient-beyazimsi">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 formeleman">
                                        ...
                                        Form::Olustur("1", array(
                                            "action" => URL . "/uye/adminsifreguncelle",
                                            "method" => "POST"
                                        ));
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 formeleman nocizgi"><?php
                                        ...
                                        Form::Olustur("2", array("type" => "hidden", "name" => "adminid","value"=>$veri["sifredegistir"]));
