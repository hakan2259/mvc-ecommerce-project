<?php require 'views/YonPanel/header.php'; ?>
        ...
        <div class="col-xl-12 col-md-12 mb-12 text-center">
                ...
                if (!$_POST) :
                    ...
                    <div class="row text-left border-bottom-mvc mb-2">
                        ...
                        <div class="col-xl-12 col-md-12 mb-12 border-left-mvc text-left p-2 mb-2"><h1
                                    class="h3 mb-0 text-gray-800"><i class="fas fa-th basliktext"></i> ÜYE GÜNCELLE
                            </h1></div>

                        <?php $PanelHarici->BreadCrumb("uyeler","Üyeler","Üye Güncelleme")?>
                        ...
                        <div class="row text-center">
                            ...
                            <div class="col-xl-4 col-md-6 mx-auto">
                                ...
                                <div class="row bg-gradient-beyazimsi">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 bg-gradient-mvc pt-2 basliktext2"><h3>Üye
            ...
            if (isset($veri["UyeadresBak"])) :
                ...
                <div class="row text-left border-bottom-mvc mb-2">
                    ...
                    <div class="col-xl-12 col-md-12 mb-12 border-left-mvc text-left p-2 mb-2"><h1
                                class="h3 mb-0 text-gray-800"><i class="fas fa-th basliktext"></i> ÜYE ADRESLERİ </h1>
                    </div>

                    <?php $PanelHarici->BreadCrumb("uyeler","Üyeler","Üye Adresleri")?>
  ...
  <div class="alert alert-warning">Kayıtlı adres yok</div>
</div>';

                                } else {
                                    foreach ($veri["UyeadresBak"] as $value) {

                                        echo '  <div class="col-lg-12 col-md-12 col-sm-12 formeleman">' . $value["adres"];
                                        echo $value["varsayilan"] == 1 ? "<br><span class='text-danger'>(Varsayilan)</span>" : "";
                                        echo '<hr></div>';
            ...
            <div class="row text-left border-bottom-mvc mb-2">
                ...
                <div class="col-lg-2 col-xl-2 col-md-12 mb-12 border-left-mvc text-left p-2 mb-2"><h1
                            class="h3 mb-0 text-gray-800"><i class="fas fa-th basliktext"></i> ÜYELER </h1></div>


                <div class="col-lg-3 col-xl-3 col-md-12 mb-12 p-2"><h1 class="h3 mb-0 text-gray-800">Toplam Üye
                        : <?php echo $veri["totalData"]; ?></h1></div>
...
<a href="' . URL . '/panel/uyeGuncelle/' . $value["id"] . '" class="fas fa-sync mt-1 guncelbuton"></a></div>
 ...
 <a href="' . URL . '/panel/uyeSil/' . $value["id"] . '" class="fas fa-times   silbuton"></a>  </div>
                ...
                if(isset($veri["search"])){
                    $link = "/panel/uyearama/".$veri["search"]."/";
