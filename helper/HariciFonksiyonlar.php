            ...
            <div class="col-md-12" id="Bulten">
                <div class="join">
                    ...
                    <div class="sub-left-right">
                        ...
                        <input type="text" value="Mail Adresinizi Yazınız" onfocus="this.value = '';"
                               onblur="if (this.value == '') {this.value = 'Mail Adresinizi Yazınız';}"
                               name="mailadres"/>
            ...
            <div class="row arkaplan2  pb-0">
                ...
                <div class="col-xl-2 col-lg-2 col-md-12 col-sm-12 Uye_panel_siparisler" id="detaygoster">
                    ...
                    <a href="#" data-value="<?php echo $value; ?>"
                       data-value2="<?php echo $siparisler[0]["adresid"]; ?>" data-toggle="modal"
                       data-target="#exampleModalCenter" id="adres">Teslimat Adresi</a>
...
<div class="col-lg-3 urunler">' . $siparisler[$i]["toplamfiyat"] . '</div>             
    ...
    } // PANEL - ÜYENİN SİPARİŞLERİNİ GETİRİYOR // PANEL - ÜYENİN SİPARİŞLERİNİ GETİRİYOR

    function UyeyorumGetir($dizimiz, $totalPage = false, $totalData = false)
    {

        echo '<div class="row"><div class="col-md-12 text-center">';
        echo $totalData > 0 ? '<div class="alert alert-info">' . $totalData . " adet yorumunuz var</div>" : '<div class="alert alert-info">Henüz hiçbir ürüne yorum yazmamışsınız.</div>';
        ...
        if ($totalData != 0) :
            ...
            foreach ($dizimiz as $deger) :
                ...
                echo '<tr id="adresElemanlar">
                    ...
                    <td>' . $deger["tarih"] . '</td>
					<td>';
                echo ($deger["durum"] == 0) ? "<span class='onaysiz'>Onaysız</span>" : "<span class='onayli'>Onaylı</span>";
                echo '</td>					
					<td id="GuncelButonlarinanasi">					
					<input type="button" class="btn btn-sm btn-success" data-value="' . $deger["id"] . '" value="Güncelle"></td> <td>'; ?>

                <a onclick='UrunSil("<?php echo $deger["id"] ?>","yorumsil")'
                   class="btn btn-sm btn-danger">SİL</a> <?php echo '</td> </tr>';
        ...
        Pagination::Numbers($totalPage, $link);
	...
	<input type="button" class="btn btn-sm btn-success btn-block" data-value="' . $deger["id"] . '" id="AdresGuncelBtn" value="Güncelle">					
            ...
            <a onclick='UrunSil("<?php echo $deger["id"] ?>","adresSil")' class="btn btn-sm btn-danger btn-block"
               id="AdresSilBtn">SİL</a> <?php echo '</div>  

                          <div class="col-xl-12 col-lg-12 col-sm-12 col-md-12">';

            echo $deger["varsayilan"] == 1 ? ' <a class="btn btn-sm btn-default btn-block"
               id="AdresSilBtn">Varsayılan Adres</a>' : '<a onclick=\'VarsayilanYap("' . $deger["uyeid"] . '","' . $deger["id"] . '")\' class="btn btn-sm btn-warning btn-block"
               id="AdresSilBtn">Varsayılan Yap</a>';
