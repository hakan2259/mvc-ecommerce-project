    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-12 col-md-12 mb-12 text-center">
                ...
                // SİPARİS İADE TÜMÜNÜN GÖRÜNDÜĞÜ YER
                if (isset($veri["data"])) :
                    ...
                    <div class="row text-left border-bottom-mvc mb-2">
                        ...
                        <div class="col-lg-4 col-xl-4 col-md-12 mb-12 border-left-mvc text-left p-2 mb-2"><h1
                                    class="h4 mb-0 text-gray-800"><i class="fas fa-th basliktext"></i> SİPARİŞ İADE
                            </h1>
                        </div>


                        <div class="col-lg-8 col-xl-8 col-md-12 mb-12 p-2"><h1 class="h4 mb-0 text-gray-800">
                                <?php
                                if (count($siparisnumUnique) == 0):
                                    echo "BEKLEYEN İADE YOK";
                                else:
                                    echo "Onay Bekleyen Siparişler : " . count($siparisnumUnique);
                                endif;
                                ?></h1></div>
                    ...
                    ?>
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-12 col-sm-12 geneltext bg-gradient-mvc" id="iadeonayla">

                                <a href="#" data-value="<?php echo $value; ?>"
                                   class="btn btn-sm btn-dark btn-block mb-1" >ONAYLA</a>
                            </div>
