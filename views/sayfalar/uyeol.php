        ...
        <div class="registration-grids">
            ...
            <div class="reg-form">
                <div class="reg">
                    ...
                    <ul>
                        <li class="text-info"><span class="text-danger">*</span> Güvenlik Kodu: <img src="<?php echo $veri["source"]; ?>" id="capt" />
                        <a onclick="reloadEvent()" class="glyphicon glyphicon-refresh" id="reload" style="font-size: 25px; text-decoration: none; cursor:pointer;margin-left: 10px; top: 8px;"></a></li>
                        <li> <?php
                    ...
                    <p class="click">Üye olarak politikaları kabul etmiş olursunuz. <a href="#">Gizlilik politikası</a>
                    </p>
